...
type Data struct {
	...
	Wx       *Data_WX       `protobuf:"bytes,3,opt,name=wx,proto3" json:"wx,omitempty"`
}
...
func (x *Data_WX) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_WX) ProtoMessage() {}

func (x *Data_WX) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_WX.ProtoReflect.Descriptor instead.
func (*Data_WX) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_WX) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *Data_WX) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x77, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f,
	0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x57, 0x58, 0x52, 0x02, 0x77,
	0x78, 0x1a, 0x3a, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x16, 0x0a,
	...
	0x6f, 0x75, 0x74, 0x1a, 0x2c, 0x0a, 0x02, 0x57, 0x58, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x74, 0x22, 0x7b, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x63,
	...
	0x65, 0x73, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x42, 0x1c,
	0x5a, 0x1a, 0x73, 0x6c, 0x61, 0x63, 0x6b, 0x65, 0x72, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_WX)(nil),             // 8: kratos.api.Data.WX
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Data.wx:type_name -> kratos.api.Data.WX
	9,  // 8: kratos.api.Auth.expires_time:type_name -> google.protobuf.Duration
